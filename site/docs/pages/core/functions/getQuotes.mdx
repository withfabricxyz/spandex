...
/// @log: kyberswap yields 994500000n
```

```ts [config] filename="config.ts" twoslash
import { createConfig, fabric, kyberswap } from "@spandex/core";
...
export const config = createConfig({
  providers: [fabric({ appId: "your app id" }), kyberswap({ clientId: "your client id" })],
