...
To install SpanDEX with onchain simulation support, first ensure that you have the core package
installed:
...
```bash [npm]
npm i viem @withfabric/spandex-simulation
```

```bash [bun]
bun i viem @withfabric/spandex-simulation
```

```bash [pnpm]
pnpm i viem @withfabric/spandex-simulation
```
