...
- **`aggregators`**: Array of aggregator configurations (see [Getting Started](/getting-started))
- **`defaults`**: Optional default options including strategy (see [Strategies](/strategies))
...
Choose the appropriate strategy based on your use case (see [Strategies](/strategies)):
