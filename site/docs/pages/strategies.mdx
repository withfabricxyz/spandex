...
SMAL supports multiple quote selection strategies to match different use cases. When you call `fetchBestQuote()`, the strategy determines which quote is "best" from all provider responses.
